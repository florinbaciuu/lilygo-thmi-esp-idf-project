...
void v_check_0_pin_state_task(void* parameter) {
    ...
    gpio_isr_handler_add(
        (gpio_num_t)0, v_check_0_pin_state_isr_handler, (void*)xHandle_v_check_0_pin_state_task);
    while (true) {
...
extern "C" void app_main(void) {
    ...
    xTaskCreatePinnedToCore(v_check_0_pin_state_task, // Functia care ruleaza task-ul
